# Задача 4. Напишите программу, которая принимает на вход координаты двух точек и находит расстояние между 
...
Distance = round((((x2-x1)**2+(y2-y1)**2))**0.5,2)          # turn off to enable the second option
print(type(Distance))                                       # turn off to enable the second option
